...
FILES = [
    ...
    "requirements.txt",
    "keys.json",
    "_verify/check_theme.py",
    "_verify/check_requires.py",
    "_verify/probe.luau",
    "_verify/mock_types.luau",
    "src/Loader.luau",
    "src/main.luau",
    ...
    "src/ui/widgets/Dropdown.luau",
    "src/ui/widgets/GridRow.luau",
    "src/ui/widgets/Init.luau",
    "src/ui/widgets/Keybind.luau",
    "src/ui/widgets/Label.luau",
    "src/ui/widgets/Paragraph.luau",
